...
const mestre = [
  ...
  TBL(['Nível do grupo', 'Dano do grupo por rodada', 'Chefe sozinho: vida', 'Chefe: dano', 'Capanga: vida', 'Capanga: dano'],
    [
      ['2', '~38', '105 a 123', '17', '9', '4'],
      ['5', '~90', '250 a 290', '39', '22', '10'],
      ['10', '~130', '360 a 420', '75', '32', '19'],
      ['15', '~180', '500 a 580', '111', '45', '28'],
      ['20', '~220', '600 a 720', '147', '55', '37'],
      ['25', '~275', '760 a 890', '183', '68', '46'],
      ['30', '~315', '870 a 1020', '219', '78', '55'],
    ],
