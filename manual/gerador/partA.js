...
const cover = [
  ...
  new Paragraph({ alignment: AlignmentType.CENTER,
    ...
    children: [new TextRun({ text: 'Níveis 1–20  ·  Faixa lendária 21–30  ·  Versão 7.27', size: 20, color: C.grey })] }),
...
const inicio = [
  ...
  BOX('LANÇA NEGRA · CLASSE 2 · PROJÉTIL', [
    'Classe 2 dá **6 pontos**. A Melhoria **Fura** custa 2 e faz o feitiço ignorar até 4 de Redução de Dano. A Restrição **Atrasar** devolve 2, em troca de a conjuração custar a rodada inteira.',
