...
const maxima = [
  ...
  BUL('**Na corrida, segurar o domínio pede concentração.** Quem mantém um domínio e toma dano faz um **Teste de Resistência de Vigor contra a CD de quem te feriu**, a mesma rolagem da Concentração. Cada falha fica marcada até a corrida acabar, e **quando as falhas chegam a metade da sua Essência — arredondando para baixo, e nunca menos de 1 —, o seu domínio cai**.'),
  BUL('**Personagem de jogador testa a cada dano que toma, sem limite. Inimigo testa no máximo uma vez por jogador que acertou ele na rodada**, por mais golpes que esse jogador dê, e contra a maior CD entre eles. **Golpe de invocação não conta:** ele tira vida do inimigo, e não faz o inimigo testar.'),
