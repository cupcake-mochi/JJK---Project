...
**v0.250.** Fases 0 a 3 fechadas; a Fase 4 (mecânica) está em andamento com **vinte e seis peças escritas e vinte e seis validadores passando**. O manual do Fundamento está na **v7.32**, e ele é um subsistema fechado — a técnica e o feitiço já funcionam. O `.pdf` **está na mesma versão do `.docx`** desde a v0.93 — ele deixou de ser exportado a mão.
