...
**v0.51.** Fases 0 a 3 fechadas; a Fase 4 (mecânica) está em andamento com **catorze peças escritas e catorze validadores passando**. O manual do Fundamento está na **v7.8**, e ele é um subsistema fechado — a técnica e o feitiço já funcionam. O `.pdf` continua na v7.4, porque é exportado à mão.
...
**Invocações**, em `03-mecanica/RASCUNHO-invocacoes.md`. **Cinco das seis perguntas fecharam na v0.51** — iniciativa, o modelo da Matilha, a ficha, o custo e a morte. Falta o catálogo de `Traço` e `Comando`, o tratamento de Rika e Mahoraga, e o validador.
