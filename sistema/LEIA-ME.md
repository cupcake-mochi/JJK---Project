...
**v0.139.** Fases 0 a 3 fechadas; a Fase 4 (mecânica) está em andamento com **vinte e duas peças escritas e vinte e dois validadores passando**. O manual do Fundamento está na **v7.12**, e ele é um subsistema fechado — a técnica e o feitiço já funcionam. O `.pdf` **está na mesma versão do `.docx`** desde a v0.93 — ele deixou de ser exportado a mão.
