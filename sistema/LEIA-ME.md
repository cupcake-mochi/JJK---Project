...
| `03-mecanica/` | As peças de regra, numeradas na ordem em que foram escritas, e os vinte e três validadores |
...
**v0.144.** Fases 0 a 3 fechadas; a Fase 4 (mecânica) está em andamento com **vinte e três peças escritas e vinte e três validadores passando**. O manual do Fundamento está na **v7.12**, e ele é um subsistema fechado — a técnica e o feitiço já funcionam. O `.pdf` **está na mesma versão do `.docx`** desde a v0.93 — ele deixou de ser exportado a mão.
