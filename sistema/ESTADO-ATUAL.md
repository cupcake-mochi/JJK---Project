...
Atualizado em 23/09/2026, na v0.264 (última peça fechada: **Ritual**, a peça 27, na v0.262, com o `conferir-ritual.py` e sete checagens; antes dela, o **Bestiário**, a peça 26, na v0.198; antes dela, **Sem Técnica, a peça 25, na v0.168**; antes dela, **Dano de alma e Integridade, na v0.145**). Este arquivo existe para retomar o trabalho — inclusive em conversa nova — sem recontextualizar tudo. Leia ele inteiro antes de mexer em qualquer coisa: ele tem a seção *"Onde estamos, e o que falta"* no fim, que é o ponto de retomada.

**Versão v0.264.** Fases 0 a 3 fechadas; Fase 4 (mecânica) em andamento, **vinte e sete peças escritas** e **vinte e sete validadores**.
...
| 6 | **Revisar os anti-domínios** — *decisão dele na v0.226: "vamos revisar a mecânica de como esses anti domínios funcionam"* | as quatro da peça 11, e como elas se portam contra a `Expansão sem Barreiras`. *As saídas medidas estão no rascunho, seção 8.4.* ***A PESQUISA DE CAMPO SAIU na v0.264*** — `6.023` linhas em `01-pesquisa/anti-dominios/`, e o resumo das quatro com as oito divergências está no `H-resumo-das-quatro.md`. **⚠ A premissa da 8.4 está metade errada:** *a casca não é a variável, e sim a diferença de saída (`出力`) entre quem defende e quem abriu — quatro `Domínio Simples` aguentaram quase 99 s dentro de um domínio sem casca (cap. 258), e dentro de domínio FECHADO o Sukuna pagou metade do corpo (caps. 249 e 266).* **As oito divergências, em duas metades:** *conserto de fato — o "pés no chão" é voto da Miwa e não da técnica, o raio `2,21 m` é dela também, o Kusakabe expande o raio com a própria aptidão, e a `Pétala` responde ao que **toca** e não a "ataque físico" (a frase do Acerto corporal cai).* **Decisão de preço, e é dele** — *`中和` é subtração com piso e não interruptor; a `Extensão` **dilui** o Acerto em vez de anular; o `Domínio Simples` é **arrancável** e a `Cesta Oca` é **sustentável**; e o custo da `Cesta Oca` é **selo imposto**, que o inimigo pode querer que você pague* |
