...
Atualizado em 25/09/2026, na v0.270 (última peça fechada: **Ritual**, a peça 27, na v0.262, com o `conferir-ritual.py` e sete checagens; antes dela, o **Bestiário**, a peça 26, na v0.198; antes dela, **Sem Técnica, a peça 25, na v0.168**; antes dela, **Dano de alma e Integridade, na v0.145**). Este arquivo existe para retomar o trabalho — inclusive em conversa nova — sem recontextualizar tudo. Leia ele inteiro antes de mexer em qualquer coisa: ele tem a seção *"Onde estamos, e o que falta"* no fim, que é o ponto de retomada.

**Versão v0.270.** Fases 0 a 3 fechadas; Fase 4 (mecânica) em andamento, **vinte e sete peças escritas** e **vinte e sete validadores**.
...
| 14 | **As duas fichas com os Caminhos velhos** | **a ficha do repositório `Claude 3`**, *que é extraída do livro e ficou com as Trilhas antigas, o Evocador e o texto velho da Cesta e do Simples até a próxima extração;* **e a ficha deste repositório**, *em `05-material/`: o `dados.js` do gerador ainda lista as quinze Trilhas antigas e o Evocador, e a `ficha-exemplo-kaori.docx` sai dele. O `conferir-ficha.py` confere a ficha contra a peça 6, que guardou a lista antiga como registro — por isso ele segue verde e não acusa a defasagem* |
| 15 | **As decisões que a v0.270 deixou para ele** | *listadas na entrada da v0.270 do `CHANGELOG`:* **a perícia fixa do Bastião** (`Intimidação` aqui, `Provocar` na v0.4), **a frase dos Limites** que dizia que Caminho nenhum cura, **quem cura outra pessoa com Energia Reversa** agora que a `Sutura` saiu, e **as colisões de nome da triagem** (`Eco`, `Impulso` e `Sobrecarga` no manual, `Condução` nos ofícios, `Condutor Armado` com a Melhoria `Armado`, e a `Segunda Leitura` reaproveitada). *Depois das colisões, os nomes da v0.4 entram nas listas do `conferir-nomes.py`* |
