...
>
> **E a de `Invocação com arma` virou as duas regras que ela dizia faltar**, *as duas derivadas e nenhuma escolhida:* **o dado da arma não soma ao `Investir`**, *porque o `Investir` já entrega a cota inteira da Rotina e a melhor arma de tiro somaria `314%` dela no nível 2 — o teto de uma Rotina é a trava mais dura do sistema*; **e a invocação não tem Caminho, então nunca tem treino**, *o que cai na regra geral de empunhar sem treino da peça 19 §6.* *A remodelagem das invocações continua podendo mexer nas duas; o que ela não precisa mais é destravar a mesa.*
>
