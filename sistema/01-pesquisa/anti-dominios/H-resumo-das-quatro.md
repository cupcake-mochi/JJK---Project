# As quatro anti-domínio — resumo, vantagens e desvantagens

**STATUS: COMPLETO**

Consolidado das três rodadas de pesquisa (`A` a `G` em 22-23/09/2026; `I`, `J` e `K` em 24/09/2026),
a pedido do Mizuki. **É o que a OBRA estabelece.** O que o sistema publica hoje está no fim, na seção
de divergências.

Marcação: **[C]** canon, com capítulo · **[F]** fanbook/oficial fora do mangá · **[I]** inferência
de fonte secundária, com dono

> ### Atualização de 24/09/2026 — o que a terceira rodada mudou neste arquivo
>
> *A rodada foi atrás de **drawback** e de **como cada uma cai**. Três agentes (a obra, os fóruns
> japoneses, os fóruns ocidentais) chegaram por fontes diferentes nos mesmos pontos, e é isso que
> entrou aqui. Onde só um arquivo sustenta, está dito.*
>
> - **Cesta Oca:** o "quase se desfez" do 266 estava curto; o Kashimo **nem chegou a ativar** no 187;
>   o buraco da boca ficou **meio fechado**; ela ganhou um custo canônico que não estava aqui (veta o
>   corte que divide o mundo, cap. 250); e o quadro dizia que o dono **não se move** e que ela é
>   **reforçável** — as duas coisas estavam erradas.
> - **Domínio Simples:** **dentro de domínio, nunca caiu por golpe no dono** (os três arquivos
>   concordam); o cap. 254 fecha a nota do Gege do 248; ele **desgasta à vista** antes de cair.
> - **Pétala:** o "mais de um minuto" do cap. 109 é fala **sobre o Nanami**, que não tem anti-domínio;
>   a fala "efeito complexo não serve" é do **Kusakabe**, não do Choso; "exige concentração" foi
>   **derrubado** e tem origem achada.
> - **Extensão:** "um ataque com ela sempre acerta" **não é do Fanbook**; o `薄まる` é **só do cap. 84**
>   e é ambíguo; "apaga processo em andamento" estava listado como vantagem e é **custo do próprio
>   dono**; "técnica mais densa passa" virou **canon** (caps. 85 e 232).
> - **Seção nova:** como elas caem e quanto duram, nas quatro.
> - **Divergências com a peça 11:** duas linhas da coluna "a obra diz" mudaram de base (fim do arquivo).
> - **Os cinco pontos que a rodada deixou abertos** foram fechados no mesmo dia pelo
...
>
> **A primeira versão deste arquivo dizia que a Cesta Oca "pode ser REFORÇADA, e o Sukuna gastou
> mais braços e bocas para compensar saída fraca". Isso NÃO está na fonte.** *Era inferência de um
> agente, publicada por mim como canon.*
>
> **O texto do cap. 266, em japonês:**
> 宿儺は彌虚葛籠の**発動後も掌印を結んだままにすることで出力を補い**、領域に押し負ける事無く
> 戦闘をし続けることができる
> *"**Mantendo o selo de mão mesmo depois de ativar**, ele **suplementa a saída** (`出力を補い`) e
> consegue continuar lutando sem ser empurrado pelo domínio."*
>
> **O que supre a saída fraca é MANTER, não gastar mais.** *É custo contínuo, não escala.*
>
> **E os números derrubam a leitura de escala por um segundo caminho:** *no cap. 249 foi **metade
> dos braços e da boca**; no cap. 266 foram **duas mãos** — e ali o Sukuna estava com **quatro
> braços curados**.* **Nos dois casos é METADE do que ele tinha.** *Não é investir mais para ganhar
> mais: é a mesma fração, num corpo de tamanho diferente.*
>
> ### E a fala do próprio Sukuna fecha: não é gasto, é SELO imposto
>
> *Segunda correção, 23/09/2026, também levantada pelo Mizuki: **"ela não pode ser exatamente
> reforçada. Ela realmente força o usuário a ter as mãos mantendo o sinal e resistir".** Ele está
> certo, e a fonte é melhor do que a que eu tinha — é o **Sukuna analisando a estratégia inimiga**,
> em cena:*
>
> > なるほどなこれがコイツらの次の策か… **彌虚葛籠を使わせ続け腕と口の半分を封じ**、領域内でのみ
> > 発動するとみられる無制限での術式コピーで攻める。
> >
> > *"Entendi, então essa é a próxima estratégia deles… **fazer-me continuar usando a Cesta Oca,
> > selando metade dos meus braços e da boca**, e atacar com a cópia ilimitada de técnicas que só
> > funciona dentro do domínio."* **[C]** cap. 249
>
> **O verbo é `封じ` — SELAR.** *Não é o usuário gastando recurso por escolha: é o inimigo
> **prendendo** metade do corpo dele.* **A Cesta Oca ser cara é a ARMA de quem está do lado de
> fora**, e a estratégia do Yuta e do Yuji foi exatamente forçá-lo a mantê-la.
>
> *E ele não podia largar:* **o domínio do Yuta carregava a técnica do Anjo, que apagaria a técnica
> do Sukuna — e, no pior caso, ele inteiro.** *Manter não era vantagem; era a única saída.*
>
> ⚠ **A boca entra junto, e eu NÃO sei por quê.** *A fala diz "metade dos braços **e da boca**", e
> nenhuma fonte que eu li explica o que a boca tem a ver com um selo de mão.* **Fica declarado como
> buraco.** *Se for vocalização, é o componente que o Mizuki suspeitou — mas eu não tenho fonte, e
> a descrição oficial da técnica só cita o selo de dedos entrelaçados com os braços estendidos.*

> ### Atualização 24/09/2026 — o buraco da boca, meio fechado, e o "manter" posto no lugar
>
> **A boca, em quatro peças de canon** (`I` §1.3):
> - **[C] 238:** o corpo verdadeiro do Sukuna tem **quatro braços e duas bocas**, e **a boca da
>   barriga recita encantamento (`呪詞の詠唱`) sem parar**, sem pesar no coração e no pulmão.
> - **[C] 249:** *"selar metade dos braços e da boca"* (`腕と口の半分を封じ`).
> - **[C] 250:** *o corte que divide o mundo **não dá para disparar mantendo a Cesta**.*
> - **[C] 251:** quando ele solta a Cesta, o Yuta pensa que o corte precisa **de selo, de
>   encantamento ou dos dois**, arranca a língua da boca da barriga e corta a da cara:
>   「どちらもさせない!!」 *"não vou deixar fazer nenhum dos dois!!"*
>
...
> japonesas que batem. **Mas o 255 não cita a Cesta nem a boca:** "a boca presa tira dele o
> encantamento do corte" é **leitura compatível [I]**, não texto. E há uma conta que pesa contra a boca
> como explicação única: com dois dos quatro braços presos, pode faltar mão para o selo de duas mãos
> **mais** a palma **[I]** (`L`).
>
> **O "manter", posto no lugar.** O texto do 266 diz **"mesmo depois de ativar"** (`発動後も`): a
...
- **Pode nem subir a tempo.** *No 187 a narração diz que o Kashimo entendeu as regras do domínio do
  ...
  **ela nunca subiu**. **[C]** cap. 187 p. 1. *O acerto garantido daquele domínio é a transmissão de
  informação, que é inofensiva; daí a leitura de que ela é **inútil contra domínio não-letal***
  **[I]**. *(corrigido em 24/09: antes dizia que ele "considerou usá-la e desistiu"; o "foi lento
...
- Custo de energia, tamanho em número, como se aprende, limite de tempo: **[NÃO ACHEI]** nos três
  arquivos. *"Gasta pouca energia" (GameRant) é afirmação sem fonte.*
...
- **Cap. 266 → 267 — golpe no dono racha; a queda fica fora de quadro:** *os socos de alma racham a Cesta e o dono diz que ela "vai" se
  ...
  - **O mecanismo é canon, no cap. 250:** *"a cada golpe do Yuji, a saída de energia do Sukuna cai e
    ...
    impacto: ele tira a saída que a segurava* **[I]**, com as duas pontas em canon.
...
- **PODE SER ARRANCADA** (`剥がされる`) por domínio de saída maior — *e quando ela cai, o dano chega
  todo de uma vez.* **[C]** caps. 206, 226, 258; *o Kusakabe no 227 ("não é arrancada como o
...
- **Automática** — *"é um **programa** de manipulação de energia que rebate **automaticamente** o que
  toca"* (`自動で…呪力操作のプログラム`). **[C]** cap. 227, fala do Kusakabe
- **Você se move livre** — não é barreira, não prende. **[C]**
- **NÃO é arrancada como o Domínio Simples.** *Fala do **Kusakabe**.* **[C]** cap. 227 *(corrigido em
  24/09: antes atribuía ao Choso)*
- **Anda junto com a técnica reversa** — *o Gojo cura e conserta a técnica queimada com a Pétala de
  pé.* **[C]** cap. 227
- **Tem lado ofensivo:** *aplicada à espada, a lâmina golpeia sozinha o que a energia toca.* **[C]** cap. 148

> ⚠ **Saiu das vantagens em 24/09:** *"Aguenta saturação longa: o Naobito segurou mais de um minuto
> com 70% do enxame em cima. [C] cap. 108".* **O texto do cap. 109 é outro:** o Dagon pensa
> 〔およそ一分…「死累累湧軍」に耐えたのか!?〕〔髭の男も!!〕 — *"cerca de um minuto… **ele** aguentou
> o Enxame!? **O barbudo também!!**"* — e a frase é sobre o **Nanami**, que **não tem anti-domínio
> nenhum** e pegou 30% do enxame. É "cerca de", não "mais de". **[C]** cap. 109 (`I` §3.3; o `K`
> achou o mesmo pela wiki). **O minuto mede sobrevivência sob o enxame, não duração da Pétala.**

**Desvantagens**

- ⚠ **Só pega o acerto garantido que TOCA.** *Contra efeito de técnica complexo ela "não serve" —
  "tipo o Vazio Ilimitado"; contra técnica simples, tipo os cortes do Sukuna, "ajuda bastante".*
  **[C]** cap. 227, fala do **Kusakabe** *(corrigido em 24/09: antes atribuía ao Choso e citava também
  o Julgamento do Higuruma — **o texto só cita o Vazio Ilimitado**; o Higuruma é extrapolação de
  fórum **[I]**)*
- **Não se opõe à saída do domínio** — *"não se sai ileso; não é técnica que encare a saída de um
  domínio".* **[C]** cap. 227, fala do Choso
...
- **O braço do Naobito não mede a Pétala.** *Ele perdeu o braço direito no enxame **depois** do soco;
  o Nanami, sem anti-domínio, perdeu o olho esquerdo no mesmo enxame.* **[C]** cap. 109 *(ajustado em
  24/09: antes dizia "custa caro quando falha")*
- **Precisa de energia amaldiçoada** — quem não tem, não usa. **[I]** *(pela definição, ela libera a
  própria energia; o Modulo mostra um sem-energia fazendo **Simples** com energia de ferramenta)*
- **Restrita às Três Grandes Famílias na ficção.** **[C]** *O Gojo "aprendeu quando criança"
  (`子供の頃に習った`) e parou de usar quando pegou o domínio* **[C]** cap. 227; *no mesmo capítulo só o
  Kusakabe reconhece a técnica* **[C]** via wiki (`K` §3.4). *Usuários em cena: Naobito, Ogi (na
  espada) e Gojo. **Nenhum Kamo** — **[NÃO ACHEI]**.*
- ⚠ **"Exige concentração" — DERRUBADO.** *A obra a chama de programa automático (227). A frase nasceu
  num artigo da Fiction Horizon de 27/10/2023 ("Of course, the technique requires concentration"),
  sem painel, e foi copiada por um TikTok dois dias depois* (`K` §3.1). *A palavra 集中 nos caps.
  108-109 só aparece na fala do Nanami para o Megumi, sobre o **domínio do Megumi*** (`I` §3.4).
- Custo de energia e limite de tempo: **[NÃO ACHEI]**. *"Gasta muita energia" (DualShockers) é sem fonte.*
...
- **Cap. 108 — golpe no dono, por soco comum.** *(fechado em 24/09; os arquivos divergiam)*
  ...
  - O "dispelling his barrier" da wiki, que o `I` e o `J` citavam, é paráfrase de editor (2021), com
    referência genérica a nove páginas. **[I]** O `K` ("não caiu") acertou que o soco entrou por fora
    dela e errou a conclusão.
  - *Por que importa: é o **único caso da obra de anti-domínio caindo por soco comum dentro de
...
## 4 · Extensão de Domínio — 領域展延 (Ryōiki Ten'en)

**Uma membrana fina de domínio, sem técnica dentro.** Ela **neutraliza** (`中和`) o efeito de
técnica — e `中和` é o termo **químico**: quantidade igual cancela, quantidade menor **atenua**.

> **A fala do Gojo, e ela opõe parcial e absoluto de propósito:**
> 必中効果は**薄まる**が**確実に**術式を中和してくる
> *"o acerto garantido **se dilui**, mas ela neutraliza a técnica **com certeza**."* **[C]** cap. 84
>
> ⚠ **Ajustado em 24/09** (`I` §4.2): **o cap. 171 NÃO diz `薄まる`** — a caixa do 171 fala só da
> capacidade vazia e do Ilimitado. O único `薄まる` é este pensamento do Gojo no 84, e ele tem **duas
> leituras**: (A) o acerto garantido do domínio **inimigo** fica ralo; (B) o acerto garantido **da
> própria Extensão** fica ralo — e o contexto favorece a B: **no 84 não há domínio inimigo em cena**,
> o Gojo está explicando por que os golpes do Jogo e do Hanami agora encostam nele, e a frase seguinte
> é *"assim até em mim o golpe entra"*. O **Fanbook p. 143** diz
> 「領域展延の発動中は、領域展開の必中効果を中和可能。」 — *"com a Extensão ativa, é possível
> **neutralizar** o acerto garantido de uma Expansão"*, sem "ralo" **[F]** (texto conferido em duas
> citações japonesas independentes, `L` ponto 4). As leituras A e B do 84 continuam **[I]** — e a obra
> **nunca pôs a Extensão contra o acerto garantido de um domínio inimigo** (ver "Como cai").
...
- **Suspende ou anula a técnica que você tinha em curso** — *o padrão é anular (o Sukuna diz que o
  ...
  **pausa** em vez de anulação (`無効ではなく中断`).* **[C]** cap. 247. *(corrigido em 24/09: o caso do
  Mahoraga estava nas vantagens como "apaga processo em andamento"; a adaptação interrompida era a
  do próprio dono)*
- **Técnica de saída alta passa em parte.** *O Sukuna: ela neutraliza o Ilimitado neutro, de saída
  baixa, mas **o Azul reforçado e o Vermelho invertido ela não neutraliza por inteiro**
  (`中和しきれん`). E o Gojo já tinha dado a regra: "quanto mais você neutraliza minha técnica, mais
  forte eu seguro".* **[C]** caps. 232 e 85. *(novo em 24/09: era inferência japonesa do amedot)*
- **Não para o corte que divide o mundo, o Cleave nem o Desmantelar à queima-roupa.** **[C]** cap.
  246, análise do Kusakabe
- ⚠ **Contra o acerto garantido de domínio: o Fanbook diz que neutraliza, e a obra não mostra.**
  *`必中効果を中和可能`* **[F]** p. 143; *nenhuma cena a põe sozinha contra acerto de domínio inimigo*
  **[C]** por varredura. *A base do "só PARCIAL" era o `薄まる` do 84, que é ambíguo (ver acima).* **[I]**
- **Sendo subtração, quantidade menor só atenua** — não é interruptor. **[I]** *E o cap. 232 é o caso
  em cena disso: o Vermelho passa, mitigado.* **[C]**
- **Rara de verdade:** *o Kusakabe, grau 1 e maior especialista vivo em anti-domínio, não consegue.
  O Higuruma aprendeu olhando, com dois meses de jujutsu.* **[C]**
- ⚠ **Escala com atributo bruto enquanto o preço é fixo** — *alerta de balanceamento levantado pela
  própria comunidade japonesa.* *O Reddit acrescenta a espiral: golpe que baixa a saída do dono
  enfraquece a Extensão, que deixa entrar golpe mais forte* **[I]** (`K` §4.2, +7/+2).
- Custo de energia, uso junto com a reversa e limite de tempo: **[NÃO ACHEI]** nos três arquivos.
  *O mais perto de custo é o Kashimo amarrando a **troca** Extensão↔técnica à eficiência de energia
  (225).* **[C]**

**Como cai** (`I` §4.3-4.4, `J`, `K` §4.2)

- **Largada para usar a técnica — é a queda de quase todas as cenas.** *O Hanami solta para usar a
  técnica e o Jogo grita "não solta a Extensão!!" (85); o Jogo bate e foge (88); o Sukuna troca o
  tempo todo entre ela e a técnica (224-231); o Higuruma solta para reacender a Espada (247).* **[C]**
  *É também a queda mais votada no Japão (o Hanami, 知恵袋, 331 votos, `J`).*
- **Saturada por técnica mais forte, com o dono sem fôlego:** *"esse aí já não tem fôlego para
  aguentar isso, né?" — e o Gojo esmaga o Hanami.* **[C]** cap. 85; *o Vermelho no Sukuna* **[C]** cap. 232
- **Contra DOMÍNIO: nunca testada.** *Toda cena é contra técnica ou dentro de um choque de domínios
  em que os acertos já se anulavam (227-228).* **[C]** por varredura (`I` §4.4). *No Reddit a briga
  segue: "a Extensão não para acerto garantido" (+306) contra um fã citando o Fanbook (+16) — e o fã
  cita certo: o Fanbook p. 143 diz `中和可能` **[F]**. O que falta é cena.*
- **Quanto dura:** *"dura pouco" só aparece em dois blogs japoneses, sem painel* **[I]**; *o maior uso
  contínuo da obra é **~3 minutos** (228)* **[C]**. *O que a obra liga à duração é **fôlego contra
  técnica mais forte** (85), não relógio.*

---

## Como elas caem, e quanto duram — o que vale para as quatro

**Nenhuma das quatro tem relógio próprio na obra.** **[NÃO ACHEI]** — nas quatro fichas oficiais,
no Fanbook, na nota do autor do 248, na lista de comentários de fim de revista e em todas as cenas
...
**Os tempos que a obra dá, e de quem eles são de verdade** (`I` §5):
...
## Onde o nosso sistema diverge da obra hoje
...
*(v0.268: o `Domínio Simples` foi reescrito — os pés viraram o voto do iniciante (cap. 254: "o iniciante cria vários votos para o Simples se firmar; o Kusakabe firma sem voto nenhum"), ele passou a cair por um relógio de rodadas contra a Expansão — na v0.268 pela diferença de refino, e desde a v0.269 em Essência contra a do dono, com o teste do `Carregar` a cada Acerto —, e golpe no dono não o derruba; ergue de novo sem recarga, como o Gojo no 226, pagando a Ação Padrão desde a v0.269. As linhas dele nesta tabela — os pés, o raio e o "Simples × Cesta" — estão resolvidas. A `Cesta` perdeu a recarga e ganhou a queda na hora: a Expansão alcança quem ela protegia no instante em que ela cai; e na v0.269 o teste dos golpes nela passou de Vigor para o do `Carregar`.)*
