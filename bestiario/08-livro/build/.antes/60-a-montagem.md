São três passos, nesta ordem, e cada um lê uma tabela sem inventar número nenhum.

O primeiro diz quanto o inimigo aguenta, o segundo diz como ele luta, e o terceiro diz onde o
corpo cabe e até onde o braço dele chega.

# Passo 1 · A categoria

A categoria responde uma pergunta só: **quantos personagens este inimigo exige?**

O fator da categoria e o número de pessoas são a mesma coisa em duas unidades: **`personagens =
fator × 4`**. Um bicho de fator `1,92` exige `7,7` pessoas, e você lê isso sem tabela nenhuma.
...
> O fator de dano de quem tem `Intervenção` é multiplicado por `0,923`, porque a `Intervenção`
> é ação extra e não sai da cota.
...
porque um esquadrão cheio cobre os próprios buracos.
...
As frações saem com uma casa decimal e isso não é preciosismo: meio ponto percentual atravessa
a borda de uma rodada e move o encontro em treze pontos.

# Passo 2 · O papel

O papel diz como ele luta. Ele redistribui o que a categoria deu, como quem troca de bolso o
mesmo dinheiro, e nunca acrescenta.
...
Os seis fecham em `1,000` e o golpe não se move em nenhum deles.

## Pagamento do `Emboscador`

O ganho dele é quase metade a mais num ataque, e um ataque vale mais num corpo de uma ação do
que num de seis. O pagamento anda junto.

**O que o `Emboscador` paga**
{: .tab-titulo }
...
> Não copie um número só desta tabela. Um número certo no lugar errado engana igual a um
> número errado.
...
`Brutamontes` e `Guardião` ficam fora do `Capanga`, e o motivo do primeiro não é o número: um
`Capanga` que não cai num golpe é uma `Ameaça`.
...
> categoria, de graça. A folga está declarada aqui para você contar com ela.

A coluna da grade morde o teto de empilhamento: um esquadrão de oito `Capanga` `Grande` ocupa
...
|---|---|---|---|---|---|
| **2–4** | 9 · 4 | 28 · 4 | 114 · 1d4 + 3 | 171 · 1d4 + 2 | 228 · 1d4 + 3 |
| **5–8** | 22 · 2d4 + 5 | 67 · 2d4 + 5 | 270 · 2d6 + 6 | 405 · 1d10 + 6 | 540 · 2d6 + 6 |
| **9–12** | 32 · 2d8 + 10 | 97 · 2d8 + 10 | 390 · 2d12 + 12 | 585 · 2d10 + 11 | 780 · 2d12 + 12 |
| **13–16** | 45 · 4d6 + 14 | 135 · 4d6 + 14 | 540 · 4d8 + 19 | 810 · 3d10 + 17 | 1080 · 4d8 + 19 |
| **17–20** | 55 · 4d8 + 19 | 165 · 4d8 + 19 | 660 · 4d12 + 23 | 990 · 4d10 + 22 | 1320 · 4d12 + 23 |
| **21–25** | 68 · 4d10 + 24 | 206 · 4d10 + 24 | 825 · 6d10 + 28 | 1237 · 5d10 + 27 | 1650 · 6d10 + 28 |
| **26–30** | 78 · 6d8 + 28 | 236 · 6d8 + 28 | 945 · 8d8 + 37 | 1417 · 6d10 + 33 | 1890 · 8d8 + 37 |

*Vida · golpe de uma ação. O golpe sai uma vez por ação, e o número de ações está na tabela do Passo 1.*
...
**Passo 1 — a categoria.** Quatro pessoas é `Desastre`. A linha do nível 10 dá **vida `390`**, **`3` ações** e golpe `2d12 + 12`.

Um `Desastre` carrega `Intervenção`, e quem carrega paga `0,923` no golpe: `25,0 × 0,923` = **`23,1`** por ação.
...
>
> **Vida** `468` · **Integridade** `468` · **O golpe** `23,1` *(alcance 3 m)* · **Deslocamento** `9 m`
>
> **Traços**
>
> **Ações Múltiplas (3).** Ele age 3 vezes por rodada.
>
> **Ações**
>
> **Golpe.** `+6` para acertar, `23,1` de dano, alcance `3 m`. O alvo, mais metade em um vizinho.
>
> **Intervenções.** Três por luta, uma por rodada.


O orçamento de uma ação dele é `23,1 ÷ 4,5` = **`5,1` pontos**, que bate com a linha do `Desastre` na `Orçamento de uma ação, por categoria`.

<!-- FIM EXEMPLO -->

# Como o mestre escreve uma ação
...
**Área reparte a cota.** Um feitiço em área tem menos dados para comprar condição, e o próprio
Fundamento já cobra por área em ponto de feitiço.

Abaixo de `3` pontos a ação não monta feitiço. Ela bate, e o dano sai como a
`Vida e golpe por faixa` manda. Veja o bloco seco, no capítulo 5.
...
| `10` | `4,2` | `4,2` | `5,1` | `4,5` | `5,1` |
| `15` | `6,2` | `6,2` | `7,6` | `6,9` | `7,6` |
| `20` | `8,2` | `8,2` | `10,1` | `9,0` | `10,1` |
| `25` | `10,2` | `10,2` | `12,5` | `11,2` | `12,5` |
| `30` | `12,2` | `12,2` | `15,0` | `13,5` | `15,0` |

*As colunas de quem tem `Intervenção` já levam o `0,923`.*

O que cabe numa ação de quinze pontos, que é a maior do sistema:

**O que quinze pontos compram**
{: .tab-titulo }

| se ele comprar | custa | sobra para dado |
|---|---|---|
| uma condição `Leve` | `4` | `11,0` |
| uma condição `Média` | `7` | `8,0` |
| uma condição `Pesada` | `11` | `4,0` |

Uma ação de inimigo aguenta uma condição `Pesada`, e nesse caso ela vira quase só condição. É a
