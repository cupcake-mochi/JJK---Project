...
**Versão v0.97** · manual do Fundamento na **v7.9** · **dezessete peças de regra** e **dezessete validadores passando**.
...
├── manual/
│   ├── Fundamento-MANUAL-v7.docx        v7.9 — o manual gerado
│   ├── Fundamento-MANUAL-v7.pdf         v7.9 — o mesmo do .docx desde a v0.93
...
O `.pdf` **está na v7.9, igual ao `.docx`**, desde a v0.93 — ele passou sete versões do manual atrasado porque era exportado a mão pelo Word. *Hoje sai de `soffice --headless --convert-to pdf`, e a paginação bate com a do Word: 44 páginas nos dois.*
