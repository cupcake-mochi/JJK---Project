...
**Versão v0.262** · manual do Fundamento na **v7.37** · **vinte e sete peças de regra** e **vinte e sete validadores passando** · o Manual da Guilda em **19 capítulos**.
...
├── manual/
│   ├── Fundamento-MANUAL-v7.docx        v7.37 — o manual gerado
│   ├── Fundamento-MANUAL-v7.pdf         v7.37 — o mesmo do .docx desde a v0.93
