...
**Versão v0.254** · manual do Fundamento na **v7.35** · **vinte e seis peças de regra** e **vinte e seis validadores passando** · o Manual da Guilda em **18 capítulos**.
...
├── manual/
│   ├── Fundamento-MANUAL-v7.docx        v7.35 — o manual gerado
│   ├── Fundamento-MANUAL-v7.pdf         v7.35 — o mesmo do .docx desde a v0.93
